...
public static class DomSearch
{
    ...
    /// <summary>
    /// Genişlik Öncelikli Arama (BFS - Breadth First Search) kullanarak evrensel arama yapar.
    ...
    /// <summary>
    /// Derinlik Öncelikli Arama (DFS - Depth First Search) kullanarak evrensel arama yapar.
    /// Zaman Karmaşıklığı (Time Complexity): O(N)
    /// </summary>
